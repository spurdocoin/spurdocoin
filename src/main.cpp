...
uint256 hashGenesisBlock("0x00000fb7442831fb750213c94cc93e2048e36d8f6afd4cb74c404baaf74ce5cf");
...
const string strMessageMagic = "SpurdoCoin Signed Message:\n";
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000000e1654073687074dfcb50d2e9b3332f006a14ba3f78a080e59a88301f");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Lauantain piti olla juhlapaiva";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1400498599;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084826830;

        if (fTestNet)
        {
            block.nTime    = 1400360192;
            block.nNonce   = 4044606038;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3967655acaac50e08998db3791f008af094844b2767b71a5a091894cfac383b0"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("SpurdoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("SpurdoCoinMiner : ProcessBlock, block not accepted");
    }
